...
{
    public class PlaybooksDrawingController
    {
        ...
        private static readonly IList<Color> Colors = new ReadOnlyCollection<Color>(new List<Color>()
        {
            new Color(0, 128, 182), // Blue, HEX = 0080B6
            new Color(0, 183, 168), // Aqua, HEX = 00B7A8
            new Color(106, 193, 123), // Green, HEX = 6AC07A
            new Color(214, 213, 37), // Yellow, HEX = D5D537
            new Color(254, 189, 56), // Orange, HEX = FDBC38
            new Color(244, 119, 33), // Burnt Orange, HEX = F37720
            new Color(203, 36, 57), // Red, HEX = CA2339
        });
        ...
        public PlaybooksDrawingController()
        {
            _yAxisUnitVector = new Point(0, 1);
        }

        /// <summary>
        /// public facing method for drawing an Engineering Playbook, use samples/knowledge_BusinessAnalyst.json as a schema example
        /// </summary>
        ...
        protected List<VertexColorPair> GetEllipseVertices(KnowledgeModel model)
        {
            ...
            return geometry.Select((point, index) =>
                new VertexColorPair(point, Colors[index], transformAxis)).ToList();
        }
        ...
        protected List<VertexColorPair> CalculateEllipseBranchVertices(Outcome outcome, double xOffsetAngleRadians)
        {
            ...
            return geometry.Select((point, index) =>
                new VertexColorPair(point, Colors[index])).ToList();
        }
